...
export default function SearchResultGroup({
  ...
  searchResults: SearchResultsBox$data;
  ...
  const userAccessibleContent = mediaRecord.contents.find(
    ...
    >
      <Box sx={{ display: "flex", width: "100%" }}>
        ...
        >
          ...
          <Link
            color="inherit"
            href={`/courses/${userAccessibleContent.metadata.course.id}`}
          >
          ...
          <Link
            color="inherit"
            href={`/course/${userAccessibleContent.metadata.course.id}/media/${userAccessibleContent.id}`}
          >
