...
export class ApplicationsPage extends React.Component {
  constructor(props, context) {
    ...
    _defineProperty(this, "removeConsent", (clientId) => {
      this.context
        .doDelete("/applications/" + encodeURIComponent(clientId) + "/consent")
        .then(() => {
                    ...
                    dataListCells: [
                      ...
                      /*#__PURE__*/ React.createElement(
                        ...
                        application.userConsentRequired
                          ? Msg.localize("thirdPartyApp")
                          : Msg.localize("internalApp"),
                        application.offlineAccess
                          ? ", " + Msg.localize("offlineAccess")
                          : ""
                      ),
                      /*#__PURE__*/ React.createElement(
                        DataListCell,
                  ...
                  (application.consent || application.offlineAccess) &&
                    /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(
                          ...
                          /*#__PURE__*/ React.createElement(
                            ContinueCancelModal,
                            {
                              ...
                              modalMessage: Msg.localize("removeModalMessage", [
                                application.clientId,
                              ]),
                              modalContinueButtonLabel:
                                Msg.localize("confirmButton"), // defaults to 'Continue'
                              onContinue: () =>
                      ...
                      /*#__PURE__*/ React.createElement(
                        GridItem,
                        null,
                        /*#__PURE__*/ React.createElement(InfoAltIcon, null),
                        " ",
