...
export default function ShopLayout({ children }: { children: React.ReactNode }) {
    ...
    const tabIndex = sections.findIndex((section) => pathname.includes(section.path));
    ...
    return (
        <Box sx={{ p: 2 }}>
            ...
            <Typography variant="body1" color="text.secondary" mb={3}>
                Here you can view your inventory, purchase new items, or try your luck in the lottery.
            </Typography>
