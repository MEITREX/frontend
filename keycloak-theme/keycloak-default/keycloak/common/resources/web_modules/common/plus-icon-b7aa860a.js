import { Component as c, createElement as t } from "../react.js";
function e(c, t) {
  var e = {};
  for (var a in c)
  ...
  if (null != c && "function" == typeof Object.getOwnPropertySymbols) {
    var s = 0;
    for (a = Object.getOwnPropertySymbols(c); s < a.length; s++)
      t.indexOf(a[s]) < 0 &&
        Object.prototype.propertyIsEnumerable.call(c, a[s]) &&
        (e[a[s]] = c[a[s]]);
  }
  return e;
}
...
function s(c, t) {
  ...
  return (
    (h = { next: l(0), throw: l(1), return: l(2) }),
        ...
        for (; n; )
          try {
            if (
              ...
              return s;
            switch (((a = 0), s && (h = [2 & h[0], s.value]), h[0])) {
              case 0:
              case 1:
                s = h;
                break;
...
function h(c, t) {
  var e = "function" == typeof Symbol && c[Symbol.iterator];
  if (!e) return c;
  var a,
    s,
    h = e.call(c),
    n = [];
  try {
    for (; (void 0 === t || t-- > 0) && !(a = h.next()).done; ) n.push(a.value);
  } catch (c) {
    s = { error: c };
  } finally {
    try {
...
function n() {
  for (var c = [], t = 0; t < arguments.length; t++)
    c = c.concat(h(arguments[t]));
  return c;
}
var l;
!(function (c) {
  (c.sm = "sm"), (c.md = "md"), (c.lg = "lg"), (c.xl = "xl");
})(l || (l = {}));
let f = 0;
function i({
  name: a,
  ...
  return (
    ((o = class extends c {
      constructor() {
        super(...arguments), (this.id = "icon-title-" + f++);
      }
      render() {
        const c = this.props,
          { size: a, color: f, title: o, noVerticalAlign: v } = c,
          C = e(c, ["size", "color", "title", "noVerticalAlign"]),
          g = Boolean(o),
          m = ((c) => {
            switch (c) {
              case l.sm:
          ...
          O = -0.125 * Number.parseFloat(m),
          u = v ? null : { verticalAlign: O + "em" },
          z = [s, h, n, i].join(" ");
        return t(
          "svg",
          Object.assign(
            {
              ...
              width: m,
              viewBox: z,
              "aria-labelledby": g ? this.id : null,
              "aria-hidden": !g || null,
              role: "img",
            },
            C
          ),
          g && t("title", { id: this.id }, o),
          t("path", { d: r })
        );
      }
    }).displayName = a),
...
//# sourceMappingURL=plus-icon-b7aa860a.js.map
