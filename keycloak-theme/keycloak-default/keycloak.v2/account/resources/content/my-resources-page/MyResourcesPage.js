...
export class MyResourcesPage extends React.Component {
  ...
  hasNext() {
    if (this.isSharedWithMeTab()) {
      return (
        this.state.sharedWithMe.nextUrl !== null &&
        this.state.sharedWithMe.nextUrl !== ""
      );
    } else {
      return (
        this.state.myResources.nextUrl !== null &&
        this.state.myResources.nextUrl !== ""
      );
    }
  }
  ...
  hasPrevious() {
    if (this.isSharedWithMeTab()) {
      return (
        this.state.sharedWithMe.prevUrl !== null &&
        this.state.sharedWithMe.prevUrl !== ""
      );
    } else {
      return (
        this.state.myResources.prevUrl !== null &&
        this.state.myResources.prevUrl !== ""
      );
    }
  }
  ...
  fetchResources(url, extraParams) {
    this.context
      ...
      .then((response) => {
        ...
        resources.forEach(
          (resource) =>
            (resource.scopes = resource.scopes.map(this.makeScopeObj))
        );
  ...
  fetchShareRequests(resource) {
    this.context
      .doGet("/resources/" + resource._id + "/permissions/requests")
      .then((response) => {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      /*#__PURE__*/ React.createElement(
        ...
        /*#__PURE__*/ React.createElement(
          ...
          sharedResourcesTab &&
            /*#__PURE__*/ React.createElement(SharedResourcesTable, {
              resources: resources,
            })
        )
      )
