  ...
  return (
    <div className="rounded-lg bg-meitrex_surface_a0">
      <List
        subheader={
          title && (
            <ListSubheader className="rounded-lg bg-meitrex_surface_a0 overflow-hidden text-ellipsis whitespace-nowrap">
              {title}
            </ListSubheader>
          )
        }
  ...
  return (
    <div
      className={clsx("relative", {
        "bg-gradient-to-r from-meitrex_surface_a20 to-transparent": isActive,
      })}
    >
      {isActive && (
