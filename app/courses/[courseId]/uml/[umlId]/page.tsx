...
import {
  UmlApiGetUmlExerciseByAssessmentIdQuery
} from "@/__generated__/UmlApiGetUmlExerciseByAssessmentIdQuery.graphql";
import { umlApiGetUmlExerciseByAssessmentId } from "@/components/hylimo/api/UmlApi";
...
export default function StudentUMLAssignment() {
  ...
  const data = useLazyLoadQuery<UmlApiGetUmlExerciseByAssessmentIdQuery>(
    umlApiGetUmlExerciseByAssessmentId,
    { assessmentId: umlId }
  );
