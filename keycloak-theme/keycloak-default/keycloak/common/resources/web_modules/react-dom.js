...
!(function (e, t) {
  ...
  function xt(e) {
    return null === So ? ((So = [e]), (Co = mo(vo, St))) : So.push(e), Eo;
  }
  function Tt() {
    if (null !== Co) {
      var e = Co;
    ...
    switch (t.tag) {
          ...
          if (((e = Yt(jo.current)), zn(t))) {
            ...
            switch (((l[aa] = t), (l[oa] = a), i)) {
              ...
              case "details":
                ...
                break;
              case "input":
                x(l, a), ue("invalid", l), ye(r, "onChange");
                break;
              case "select":
            ...
            switch (
              ...
              case "details":
                ...
                break;
              case "input":
                x(e, l), (u = E(e, l)), ue("invalid", e), ye(r, "onChange");
                break;
              case "option":
                u = _(e, l);
                break;
      ...
      case 19:
        ...
        if (((i = 0 != (64 & t.effectTag)), null === (a = l.rendering))) {
          if (i) Kn(l, !1);
          else if (Mu !== xu || (null !== e && 0 != (64 & e.effectTag)))
  ...
  function hr(e) {
    if (0 !== e.lastExpiredTime)
      (e.callbackExpirationTime = 1073741823),
        ...
        (e.callbackNode = xt(vr.bind(null, e)));
    else {
      var t = mr(e),
        n = e.callbackNode;
      if (0 === t)
  ...
  function gr(e, t) {
    ...
    var r = mr(e);
    if (0 !== r) {
      if (((t = e.callbackNode), (Nu & (ku | Eu)) !== bu)) throw Error(n(327));
  ...
  function vr(e) {
    var t = e.lastExpiredTime;
    if (((t = 0 !== t ? t : 1073741823), (Nu & (ku | Eu)) !== bu))
      throw Error(n(327));
  ...
  function Ir(e, t) {
    ...
    if ((Nu & (ku | Eu)) !== bu) throw Error(n(327));
    ...
    if (
      ...
      do {
        try {
          for (w = e; null !== Qu; ) {
            var x = Qu.effectTag;
            if ((36 & x && tr(w, Qu.alternate, Qu), 128 & x)) {
              k = void 0;
              var T = Qu.ref;
              if (null !== T) {
                var S = Qu.stateNode;
  ...
  function Rr() {
    if (null === $u) return !1;
    var e = $u;
    if ((($u = null), (Nu & (ku | Eu)) !== bu)) throw Error(n(331));
    var t = Nu;
    for (Nu |= Eu, e = e.current.firstEffect; null !== e; ) {
      try {
        var r = e;
  ...
  function Qr(e, t, r, l, i, a) {
    ...
    if (((l = e), "function" == typeof e)) Vr(e) && (o = 1);
      ...
      e: switch (e) {
        ...
        case El:
          return (
            ((e = rc(12, r, t, 8 | i)).elementType = El),
            (e.type = El),
            (e.expirationTime = a),
            e
          );
  ...
  var gl = /^(.*)[\\\/]/,
    ...
    El = vl ? Symbol.for("react.profiler") : 60114,
    xl = vl ? Symbol.for("react.provider") : 60109,
      ...
      extractEvents: function (e, t, n, r, l) {
        ...
        return (
          a
            ? (ya &&
                "ko" !== n.locale &&
                (Ea || a !== wa.compositionStart
                  ? a === wa.compositionEnd && Ea && (i = Ve())
  ...
  var ao = [],
    ...
    ru = {
      ...
      useTransition: function (e) {
        var t = un(on),
          n = t[0];
        return (t = t[1]), [En(Tn.bind(null, t, e), [t, e]), n];
      },
    },
    lu = {
      readContext: Ot,
  ...
  !(function (e) {
    ...
    (e.flushSync = function (e, t) {
      if ((Nu & (ku | Eu)) !== bu) throw Error(n(187));
      var r = Nu;
      Nu |= 1;
      try {
