...
export default function NotificationPopOver({ anchorEl, setAnchorEl, setNotifications, notifications }: NotificationPopOverProps) {
    ...
    const handleDelete = (event: React.MouseEvent, index: number) => {
        ...
        setNotifications((prev: any) => prev.filter((_: any, i: any) => i !== index));
    };
                            ...
                            <Link href={note.href} style={{ textDecoration: "none" }}>
                                <Box
                                    sx={{
                                        ...
                                        border: note.read ? '1px solid #e0e0e0' : '2px solid #009bde',
                                        boxShadow: note.read
                                            ? 'none'
