...
export class ResourcesTable extends AbstractResourcesTable {
  ...
  fetchPermissions(resource, row) {
    this.context
      .doGet(`/resources/${encodeURIComponent(resource._id)}/permissions`)
      .then((response) => {
  ...
  removeShare(resource, row) {
    ...
    return this.context
      .doPut(
        `/resources/${encodeURIComponent(resource._id)}/permissions`,
        permissions
      )
      .then(() => {
              ...
              dataListCells: [
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  resource.shareRequests.length > 0 &&
                    /*#__PURE__*/ React.createElement(PermissionRequest, {
                      resource: resource,
            ...
            /*#__PURE__*/ React.createElement(
              ...
              /*#__PURE__*/ React.createElement(Dropdown, {
                ...
                toggle: /*#__PURE__*/ React.createElement(KebabToggle, {
                  onToggle: (isOpen) =>
                    this.onContextToggle(
                      row + this.props.resources.data.length + 1,
                      isOpen
                    ),
                }),
                isOpen:
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    (toggle) =>
                      /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(ShareAltIcon, null),
                        " ",
                        /*#__PURE__*/ React.createElement(Msg, {
                          msgKey: "share",
                        })
                  ...
                  /*#__PURE__*/ React.createElement(
                    ...
                    (toggle) =>
                      /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(EditAltIcon, null),
                        " ",
                        /*#__PURE__*/ React.createElement(Msg, {
                          msgKey: "edit",
                        })
                  ...
                  /*#__PURE__*/ React.createElement(ContinueCancelModal, {
                    render: (toggle) =>
                      /*#__PURE__*/ React.createElement(
                        ...
                        /*#__PURE__*/ React.createElement(Remove2Icon, null),
                        " ",
                        /*#__PURE__*/ React.createElement(Msg, {
                          msgKey: "unShare",
                        })
