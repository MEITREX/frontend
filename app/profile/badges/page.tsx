...
export default function BadgesPage() {
    ...
    const { currentUserInfo } = useLazyLoadQuery<pagePrivateProfileStudentBadgeQuery>(
        graphql`
              query pagePrivateProfileStudentBadgeQuery {
                currentUserInfo {
                  id
                  userName
                }
    ...
    return (
        <Box sx={{ p: 2 }}>
            ...
            <Typography>This is the badges section of your profile. Stay tuned!</Typography>
        </Box>
    );
}
